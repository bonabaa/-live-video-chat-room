...
Section "CCStreamer (required)" SecCore
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
	...
	CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\CC Streamer.lnk" "$INSTDIR\sqs520\cc\CCVisionMcuStreams.exe"

   CreateShortCut "$DESKTOP\CC Streamer.lnk" "$INSTDIR\sqs520\cc\CCVisionMcuStreams.exe"
  ...
  ExecWait 'regsvr32.exe /s "$INSTDIR\sqs520\cc\YYSpriteX-2.ocx"'
...
Function .onInstSuccess
 	Exec 'sqs520\cc\CCVisionMcuStreams.exe'
Functionend
;--------------------------------
;Uninstaller Section
...
Section "Uninstall"
  ...
  ExecWait 'regsvr32.exe /u /s "$INSTDIR\sqs520\cc\YYSpriteX-2.ocx"'

  Delete "$INSTDIR\libyy.dll"
  Delete "$INSTDIR\yavcodec.dll"
  Delete "$INSTDIR\msvcr71.dll"
  Delete "$INSTDIR\sqs520\cc\YYSpriteX-2.ocx"
  Delete "$INSTDIR\sqs520\cc\CCVisionMcuStreams.exe"
