...
!define X_PRODUCT "手牵手多人视频" ;Define your own software name here
!define X_VERSION "1.0.1" ;Define your own software version here

!define X_REGPATH "SOFTWARE\SQSVideo"

!define BBQBIN_DIR  "."

  ;Name and file
Name "${X_PRODUCT} ${X_VERSION}"
;OutFile "./SQSVideo_installer.exe" ; specified in command line, /D"OutFile ./vfonsvr_[d/nd]_installer.exe"
...
;Pages
  ...
  !define MUI_FINISHPAGE_LINK "Visit http://www.sqs520.com/"
  !define MUI_FINISHPAGE_LINK_LOCATION "http://www.sqs520.com/"
...
Section "SQSVideo (required)" SecCore
 ...
 ; File "${BBQBIN_DIR}\index_en.html"
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
	...
	CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\手牵手多人视频.lnk" "$INSTDIR\CCVision.exe"

   CreateShortCut "$DESKTOP\手牵手多人视频.lnk" "$INSTDIR\CCVision.exe"
  ...
  ;ExecWait '$INSTDIR\InstallPrinter.exe'
  ExecWait 'si.exe /q'
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\SQSVideo.exe"
  Delete "$INSTDIR\index.html"
  Delete "$INSTDIR\si.exe"
  Delete "$INSTDIR\yImageEngine.exe"
  Delete "$INSTDIR\SQSVideoRecord.exe"
  Delete "$DESKTOP\SQS Video.lnk"
  ...
  !insertmacro MUI_STARTMENU_GETFOLDER Application $MUI_TEMP
    ...
    Delete "$SMPROGRAMS\$MUI_TEMP\CC Vision.lnk" 
