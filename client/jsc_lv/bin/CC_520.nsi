...
Section "CCStreamer (required)" SecCore
  ...
  File "${BBQBIN_DIR}\sqs520\GamePlaza.exe"
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
	...
	CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\CC Streamer.lnk" "$INSTDIR\sqs520\GamePlaza.exe"

   CreateShortCut "$DESKTOP\CC Streamer.lnk" "$INSTDIR\sqs520\GamePlaza.exe"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\sqs520\GamePlaza.exe"
