...
protected:
  SIPHandler(
	...
	SIPHandler(SIPEndPoint & ep, const SIPParameters & params, const PString& paramcallID);
public:
  ~SIPHandler();
...
class SIPHandlersList
{
  public:
     ...
     * sip.seconix.com
     */
    PSafePtr<SIPHandler> FindSIPHandlerByUrl(const SIPURL & url, SIP_PDU::Methods meth, PSafetyMode m);
    PSafePtr<SIPHandler> FindSIPHandlerByUrl(const SIPURL & url, SIP_PDU::Methods meth, const PString & eventPackage, PSafetyMode m);
