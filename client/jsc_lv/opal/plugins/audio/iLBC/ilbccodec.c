 ...
 * $Revision: 20740 $
 * $Author: rjongbloed $
 * $Date: 2008-08-27 04:00:14 +0000 (Wed, 27 Aug 2008) $
 */
...
static const char sdpILBC[]  = { "G729"/*"iLBC"*/ };
#define C_PT 18
...
static struct PluginCodec_Definition iLBCCodecDefn[] =
{
  { 
    ...
    /*&ilbcCap*/ NULL                           // h323CapabilityData
  },
 ...
 void* g_GetcodecdefiLBCPointer(int * count)
{
  *count = 2;//sizeof(iLBCCodecDefn)/ sizeof(struct PluginCodec_Definition);
  return &iLBCCodecDefn[0];
}
