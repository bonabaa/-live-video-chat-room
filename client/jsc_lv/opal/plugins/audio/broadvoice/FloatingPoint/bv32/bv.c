...
int   main_chy(int argc, char **argv)
{
   ...
   fprintf(stderr,"/***************************************************************************/\n");
   fprintf(stderr,"/* BroadVoice(R)32, Copyright (c) 2000-09, Broadcom Corporation.           */\n");
   ...
   if (enc){
#if G192BITSTREAM
      fprintf(stderr," BroadVoice32 Floating-Point Encoder V1.1 with ITU-T G.192\n");
#else
      fprintf(stderr," BroadVoice32 Floating-Point Encoder V1.1 with packed bit-stream\n");
#endif
...
#if G192BITSTREAM
      fprintf(stderr," BroadVoice32 Floating-Point Decoder V1.1 with ITU-T G.192\n");
#else
      fprintf(stderr," BroadVoice32 Floating-Point Decoder V1.1 with packed bit-stream\n");
#endif
