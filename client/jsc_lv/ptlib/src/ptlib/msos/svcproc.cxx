 ...
 * $Revision: 23344 $
 * $Author: rjongbloed $
 * $Date: 2009-09-05 06:12:00 +0000 (Sat, 05 Sep 2009) $
 */
...
int PServiceProcess::InternalMain2(void * arg)
{
  //{
...
void PServiceProcess::MainEntry(DWORD argc, LPTSTR * argv)
{
  ...
  status.dwServiceType =  SERVICE_WIN32 | SERVICE_INTERACTIVE_PROCESS/*SERVICE_INTERACTIVE_PROCESS|SERVICE_WIN32_OWN_PROCESS*/;
...
bool NT_ServiceManager::Create(PServiceProcess * svc)
{
  ...
  schService = CreateService(
                    ...
                    SERVICE_WIN32_OWN_PROCESS | SERVICE_INTERACTIVE_PROCESS/*SERVICE_INTERACTIVE_PROCESS|SERVICE_WIN32_OWN_PROCESS*/,      // service type
