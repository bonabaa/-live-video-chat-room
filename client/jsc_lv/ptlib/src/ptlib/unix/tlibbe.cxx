 ...
 * $Revision: 21219 $
 * $Author: rjongbloed $
 * $Date: 2008-10-02 03:52:00 -0500 (Thu, 02 Oct 2008) $
 */
...
PBoolean PThread::WaitForTermination(const PTimeInterval &  ) const // Fix timeout
{
...
int PThread::PXBlockOnChildTerminate(int pid, const PTimeInterval & ) // Fix timeout
{
  status_t result = B_NO_ERROR;
  status_t exit_value = B_NO_ERROR;
