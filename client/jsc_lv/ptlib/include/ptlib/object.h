...
#if defined(__GNUCHYCHYC__) && __GNUC__ >= 4 && !defined(P_MINGW)
...
#define PSPECIAL_DELETE_FUNCTION \
    void operator delete(void * ptr, const char *, int) \
      { PMemoryHeap::Deallocate(ptr, Class2()); } \
    void operator delete[](void * ptr, const char *, int) \
      { PMemoryHeap::Deallocate(ptr, Class2()); }
#endif
...
#define PNEW_AND_DELETE_FUNCTIONS \
    void * operator new(size_t nSize, const char * file, int line) \
      { return PMemoryHeap::Allocate(nSize, file, line, Class2()); } \
    void * operator new(size_t nSize) \
      { return PMemoryHeap::Allocate(nSize, NULL, 0, Class2()); } \
    void operator delete(void * ptr) \
      { PMemoryHeap::Deallocate(ptr, Class2()); } \
    void * operator new(size_t, void * placement) \
      { return placement; } \
...
#define PCLASSINFO(cls, par) \
  public: \
    static inline const char * Class2() \
      { return #cls; } \
    virtual PBoolean InternalIsDescendant(const char * clsName) const \
      { return strcmp(clsName, cls::Class2()) == 0 || par::InternalIsDescendant(clsName); } \
    virtual const char * GetClass(unsigned ancestor = 0) const \
      { return ancestor > 0 ? par::GetClass(ancestor-1) : cls::Class2(); } \
    virtual Comparison CompareObjectMemoryDirect(const PObject & _obj) const \
      { return (Comparison)memcmp(this, &_obj, sizeof(cls)); } \
    PNEW_AND_DELETE_FUNCTIONS
...
#if P_USE_ASSERTS
template<class BaseClass> inline BaseClass * PAssertCast(BaseClass * obj, const char * file, int line) 
  { if (obj == NULL) PAssertFunc(file, line, BaseClass::Class2(), PInvalidCast); return obj; }
#define PDownCast(cls, ptr) PAssertCast<cls>(dynamic_cast<cls*>(ptr),__FILE__,__LINE__)
#else
#define PDownCast(cls, ptr) (dynamic_cast<cls*>(ptr))
#endif
...
#define PIsDescendant(ptr, cls)    ((ptr)->InternalIsDescendant(cls::Class2()))
#define PIsDescendantStr(ptr, str) ((ptr)->InternalIsDescendant(str))
...
#if P_USE_ASSERTS
template<class BaseClass> inline BaseClass * PAssertCast(PObject * obj, const char * file, int line) 
  { if (obj->InternalIsDescendant(BaseClass::Class2())) return (BaseClass *)obj; PAssertFunc(file, line, BaseClass::Class2(), PInvalidCast); return NULL; }
#define PDownCast(cls, ptr) PAssertCast<cls>((ptr),__FILE__,__LINE__)
#else
#define PDownCast(cls, ptr) ((cls*)(ptr))
#endif
...
class PObject {
  ...
  //@{
    /** Get the name of the class as a C string. This is a static function which
       ...
       @return pointer to C string literal.
     */      
    static inline const char * Class2()    { return "PObject"; }
    ...
    /** Get the current dynamic type of the object instance.
       ...
       @return pointer to C string literal.
     */
    virtual const char * GetClass(unsigned ancestor = 0) const { return ancestor > 0 ? "" : this->Class2(); }
